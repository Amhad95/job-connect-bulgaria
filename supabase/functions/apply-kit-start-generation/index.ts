...
async function callAI(
    ...
    // Try Supabase built-in AI first
    try {
    ...
    // Fallback: OpenAI API if key is available
    ...
    throw new Error(
        "No AI provider available. Configure OPENAI_API_KEY or ensure Supabase AI is available."
    );
}
